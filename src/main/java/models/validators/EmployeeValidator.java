...
/**
 * 従業員インスタンスに設定されている値のバリテーション行うクラス
 *
 *
 */
public class EmployeeValidator {
     ...
     * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するかどうか(実施す：true 実施しない:false)
    ...
    public static List<String> validate(
         ...
         * @param service EmployeeServiceのインスタンス
         * @param code 社員番号
         * @return 従業員テーブルに登録されている同一社員のデータの件数
         */
        ...
        /**
         * 氏名に入力値があるかをチェックし、入力がなければエラーメッセージを返却
         * @param name 氏名
         * @return エラーメッセージ
         */
